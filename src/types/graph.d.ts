...
export interface Mutation {
  ...
  RequestEmailVerification: RequestEmailVerificationResponse;
  ToggleDrivingMode: ToggleDrivingModeResponse;
  UpdataMyProfile: UpdataMyProfileResponse;
}
...
export interface UpdataMyProfileMutationArgs {
...
export interface UpdataMyProfileResponse {
  ok: boolean;
  error: string | null;
}
